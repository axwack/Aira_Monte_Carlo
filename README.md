...
Live  success rate shift — re-run MC from actual current portfolio value so the headline success % reflects reality, not plan-day projections. That's the big one for adaptive planning

**Status:** Released v 1.0.3
